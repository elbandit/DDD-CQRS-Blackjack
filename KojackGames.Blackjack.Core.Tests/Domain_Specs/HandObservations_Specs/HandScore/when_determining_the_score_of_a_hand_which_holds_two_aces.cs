...
namespace KojackGames.Blackjack.Core.Tests.Domain_Specs.HandScore_specs
{
    ...
    public class when_determining_the_score_of_a_hand_which_holds_two_aces
    {
        private Establish context = () =>
        {
            ...
            hand.Stub(x => x.number_of_visible_aces).Return(2);
        };

        private Because of = () => result = SUT.calculate_score_for(hand);

        private It should_score_the_hand_correctly = () => Assert.That(result, Is.EqualTo(19));
